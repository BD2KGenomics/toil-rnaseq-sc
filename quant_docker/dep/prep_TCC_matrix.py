# This is a modified version of the Pachter Lab's "prep_TCC_matrix.py" from github.com/pachterlab/scRNA-Seq-TCC-prep commit 0469873 (/source/prep_TCC_matrix.py)
# The original version of the file can be found at https://github.com/pachterlab/scRNA-Seq-TCC-prep/blob/0469873bdadcc48e34782882dbd24c3939c0542a/source/prep_TCC_matrix.py
